...
const Footer = () => {
    return (
        <footer className="bg-[#F8F8F8] pt-[30px] pb-[15px]">
            <p className="text-sm sm:text-base leading-[18px] sm:leading-[20px] md:leading-[22px] lg:leading-[24px] xl:leading-[26px] font-normal text-black text-center px-[15px] sm:px-[30px] md:px-[40px] lg:px-[50px] xl:px-[60px]">
            ...
            <div className="flex justify-between items-start flex-wrap px-[15px] sm:px-[30px] md:px-[40px] lg:px-[50px] xl:px-[60px]">
                ...
                <div className="mr-0 mb-[18px]">
                    ...
                    <ul className="p-0 footer-menu-ul-wrapper">
                        <li className="mb-[16px]">
                            <Link href="mailto:hello@okirikiri.com​" className="block text-base font-normal text-black">
                                hello@okirikiri.com​                                          
                            </Link>
                        </li>
                        <li className="">
