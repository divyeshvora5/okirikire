...
const Footer = () => {
    ...
    return (
        <footer className="bg-[#F8F8F8] pt-[30px] pb-[15px]">
            ...
            <div className="flex justify-between items-start flex-col sm:flex-row px-[15px] sm:px-[30px] md:px-[40px] lg:px-[50px] xl:px-[60px]">
                <div className="mr-0 mb-[24px]">
                    <Link href="/" className="w-[180px] sm:w-[225px] h-[auto] overflow-hidden block">
                        <img
                ...
                <div className="mr-0 mb-[24px]">
                    <h6 className="font-bold text-base md:text-lg text-black mb-[12px] sm:mb-[18px]">Company Links</h6>
                    <ul className="p-0 footer-menu-ul-wrapper">
                        <li className="mb-[12px] sm:mb-[16px]">
                ...
                <div className="mr-0 mb-[24px]">
                    <h6 className="font-bold text-base md:text-lg text-black mb-[12px] sm:mb-[18px]">Useful Links</h6>
                    <ul className="p-0 footer-menu-ul-wrapper">
                        <li className="mb-[12px] sm:mb-[16px]">
                ...
                {/* <div className="mr-0 mb-[24px]">
                    <h6 className="font-bold text-base md:text-lg text-black mb-[12px] sm:mb-[18px]">Other Links</h6>
                    <ul className="p-0 footer-menu-ul-wrapper">
                        <li className="mb-[12px] sm:mb-[16px]">
                ...
                <div className="mr-0 mb-[24px]">
                    <h6 className="font-bold text-base md:text-lg text-black mb-[12px] sm:mb-[18px]">Contact Info</h6>
                    <ul className="p-0 footer-menu-ul-wrapper">
                        <li className="mb-[12px] sm:mb-[16px]">
